...
// container indan gelecek { movie = {}, isCompact = true }
// isCompact ise aciklamanin 2 satirda bitip ... ile tamamlanmasi icin
    ...
    <div className={styles.movieWrapper}>
      ...
      <div className={styles.moviePoster}>
        ...
        <Image
          ...
          fill
        />
        {/* Image  fill verildiginde Next.js bunu absolute yapar ve tum ekrani kaplar */}
      </div>
    </div>
  );
}
